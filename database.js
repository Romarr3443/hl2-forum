...
if (count.c === 0) {
    const stmt = db.prepare('INSERT INTO achievements VALUES (?, ?, ?, ?, ?)');
    [
        [null, 'Новичок', 'Новичок', 0, 'Только начал свой путь', '🌟'],
        [null, 'Хедкраб', 'Хедкраб', 5, 'Любитель хедкрабов', '🦀'],
        [null, 'Активист', 'Активист', 10, 'Активный участник форума', '⭐'],
        [null, 'Вортигонт', 'Вортигонт', 25, 'Друг вортигонтов', '👽'],
        [null, 'Ветеран', 'Ветеран', 50, 'Опытный участник', '💫'],
        [null, 'Элита', 'Элита', 100, 'Элита форума', '👑'],
        [null, 'G-Man', 'G-Man', 200, 'Загадочная личность', '🎩'],
        [null, 'Легенда', 'Легенда', 500, 'Легенда HL2 Форума', '🔥']
